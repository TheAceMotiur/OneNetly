...
<div class="tab-content">
    {if $type !== 'testimonial-add' && $type !== 'testimonial-edit' && $type !== 'seo-image'}
        <div class="tab-pane tab-pane--predefined-icons is-active" id="{$type}-predefined-icons">
    ...
    {/if}
    <div class="tab-pane tab-pane--predefined-illustrations" id="{$type}-predefined-illustration">
        <div class="media" data-media-container>
            <div class="media__search input-group">
                <i class="input-group__addon lm lm-search"></i>
                <input type="text" class="form-control" placeholder="Search" data-media-search>
    ...
    <div class="tab-pane tab-pane--media {if ($type == 'testimonial-add' || $type == 'testimonial-edit' || $type == 'seo-image') && !empty($media)}is-active{/if}" id="{$type}-media-upload" data-media-container>
        <div class="media__search input-group">
            <i class="input-group__addon lm lm-search"></i>
            <input type="text" class="form-control" placeholder="Search" data-media-search>
        </div>
