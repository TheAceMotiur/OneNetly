<div class="tab-pane {if $smarty.get.settingsTab == 'display' || !isset($smarty.get.settingsTab)} is-active {/if}" id="settings-display">
    <div class="t-c__top top" data-top-search
        ...
        <div class="top__toolbar">
            <h3 class="section__title">Theme Display</h3><span class="form-label__counter label-docs"><a class="btn--doc btn btn--link btn--xs">docs</a>
        </div>
    </div>
                                    ...
                                    <ul class="nav">
                                        ...
                                        <li class="nav__item ">
                                            <a class="nav__link {if $display->active} is-disabled {/if}"
                                               href="{$helper->url('Display@setActiveDisplay',['templateName'=>$template->getMainName(), 'displayId' => $display->id])}">
