                ...
                <div class="app-main__content">
                    <div class="tabs__body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane {if $smarty.get.settingsTab == 'settings-general' || ($template->getActiveDisplay()->name == "Default" && !isset($smarty.get.settingsTab))} is-active {/if}" id="settings-general">
                                <div class="t-c__top top" data-top-search data-toggler-options="toggleClass: is-open;">
                                    <div class="top__toolbar">
                                        <h3 class="section__title">{$lang.settings.section.general.title}</h3>
                                        {include file="adminarea/includes/helpers/docs.tpl" link=$docs.settings.general_settings}
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="app-main__content">
                            ...
                            <div class="tab-pane {if $smarty.get.settingsTab == 'settings-order'} is-active {/if}" id="settings-order">
                                <div class="t-c__top top" data-top-search
                                    ...
                                    <div class="top__toolbar">
                                        <h3 class="section__title">{$lang.settings.section.order_process.title}</h3>
                                        {include file="adminarea/includes/helpers/docs.tpl" link=$docs.settings.order_process_settings}
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="app-main__content">
