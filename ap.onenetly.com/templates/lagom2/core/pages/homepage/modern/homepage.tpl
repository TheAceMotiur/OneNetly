                                ...
                                <div class="package package-lg">
                                    ...
                                    <div class="package-price">
                                        ...
                                        <div class="price">
                                            ...
                                            {if isset($homepage->productGroup($product.gid)->real_prices) && is_array($homepage->productGroup($product.gid)->real_prices)}
                                                {foreach $homepage->productGroup($product.gid)->real_prices as $key => $price}
                                            ...
                                            {if 
                                                ...
                                                && ($firstAvailableCycle || isset($homepage->productGroup($product.gid)->real_prices[$RSThemes['pages'][$templatefile]['config']['productGroupPriceDisplay']|lower]))
                                            }
                                                {$billingCycleName = false}
                                                {if isset($homepage->productGroup($product.gid)->real_prices[$RSThemes['pages'][$templatefile]['config']['productGroupPriceDisplay']|lower])}
                                                    ...
                                                    {else}
                                                        {$formatedPrice = formatCurrency($homepage->productGroup($product.gid)->real_prices[$RSThemes['pages'][$templatefile]['config']['productGroupPriceDisplay']|lower])}
                                                    {/if}
                                                ...
                                                {else}    
                                                    {if $firstAvailableCycle}
                                                        ...
                                                        {else}
                                                            {$formatedPrice = formatCurrency($homepage->productGroup($product.gid)->real_prices[$firstAvailableCycle])}
                                                        {/if}
