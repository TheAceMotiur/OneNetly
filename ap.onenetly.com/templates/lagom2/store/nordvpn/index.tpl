    ...
    <div class="site-banner banner banner-sides banner-{$siteBannerStyle}">
        <div class="container">
            <div class="banner-content">
                <h1 class="banner-title">{lang key="store.nordvpn.hero.title" tagOpen="" tagClose="</span>" tagBreak=""}</h1>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-12">
                        <div class="row no-gutters">
                            ...
                            <div class="col-2">
                                <span>
                                    <button class="btn btn-primary btn-get-nord" onclick="smoothScroll('#nordPricing')">
