...
{else}
    <div class="site site-nordvpn">
                    ...
                    <div class="banner-content tab-website">
                        ...
                        <form action="{routePath('cart-threesixtymonitoring-site-check')}" id="frmSiteCheck">
                            ...
                            <div class="banner-actions w-100">
                                <button type="submit" class="btn btn-search btn w-100  btn-lg btn-primary{if $siteBannerStyle == 'primary'}-faded{/if}">{$LANG.search}</button>
                            </div>
                        </form>
                    </div>
                {/if}
                ...
                role="tabpanel" aria-labelledby="pills-website-tab">
                        ...
                        <div class="site-section" id="features">
                            <div class="container">
                                ...
                                <p class="section-subtitle">{lang key="store.siteBuilder.features.essentials.tagline"}
                                </p>
            ...
            <div role="tabpanel" class="tab-pane tab-server fade {if $websitePlanCount <= 0} show active{/if}"
                ...
                <div class="site-section">
                    <div class="container">
                        ...
                        <h2 class="section-title">{lang key="store.threesixtymonitoring.websiteDiscover.title"}</h2>
                ...
                <div class="site-section">
                    <div class="container">
                        ...
                        <p class="section-subtitle">{lang key="store.threesixtymonitoring.serverMonitor.tagline"}</p>
                        <div class="section-content">
                            <div class="features features-boxes row justify-center">
        ...
        <div class="modal modal-results modal-lg fade" id="modalTestResults" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="modalTestResultsTitle">
                            {lang key="store.threesixtymonitoring.modal.title"} <span class="span-modal-results"></span>
                        </h3>
                    </div>
                    <div class="modal-body">
                        <div class="text-center">
                            <h5 class="weight-500">{lang key="store.threesixtymonitoring.modal.subtitle"}</h5>
                            ...
                            <div class="div-results">
                                ...
                                <div class="row result-values m-t-3x">
                                    <div class="col-3">
                                        <span class="metric-value weight-500" data-metric="host_status"
                                            data-metric-type="label">Online</span>
                                    </div>
                                    <div class="col-3">
                                        <span class="metric-value weight-500" data-metric="time_dns"
                                            data-metric-type="time">0.009S</span>
                                    </div>
                                    <div class="col-3">
                                        <span class="metric-value weight-500" data-metric="time_connect"
                                            data-metric-type="time">0.013S</span>
                                    </div>
                                    <div class="col-3">
                                        <span class="metric-value weight-500" data-metric="time_total"
                                            data-metric-type="time">1.257S</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-3" data-metric="host_status">
                                            <div class="metric-icon result-positive">
                                                <i aria-hidden="true" class="fas fa-circle"
                                                    title="{lang key="store.threesixtymonitoring.modal.positive"}"></i>
                                                <span
                                                    class="sr-only">{lang key="store.threesixtymonitoring.modal.positive"}</span>
                                            </div>
                                        </div>
                            ...
                            <div class="row row-legend m-t-3x m-b-3x">
                            ...
                            <div class="div-cloneable-results d-none">
                                ...
                                <div class="metric-icon result-concern">
                                    <i aria-hidden="true" class="fas fa-circle"
                                        title="{lang key="store.threesixtymonitoring.modal.concern"}"></i>
                                    <span class="sr-only">{lang key="store.threesixtymonitoring.modal.concern"}</span>
                                </div>
                                <div class="metric-icon result-negative">
                                    <i aria-hidden="true" class="fas fa-circle"
                                        title="{lang key="store.threesixtymonitoring.modal.negative"}"></i>
                    ...
                    $('#frmSiteCheck').submit(function() {
                        ...
                        WHMCS.http.jqClient.jsonPost({
                            ...
                            success: function(response) {
                                ...
                                $('.result-values [data-metric]').each(function(index,
                                    metricElement) {
                                    var metric = $(metricElement).data('metric');
                                    var dataType = $(metricElement).data(
                                        'metric-type');
                                    ...
                                    jQuery('.result-icons').find('[data-metric="' +
                                            metric + '"] .metric-icon')
                                        .replaceWith(jQuery(
                                            '.div-cloneable-results .result-' +
                                            metricData.icon).clone());
                                });
