                ...
                <div class="panel-body panel-domain-option">
                    <div class="content">
                        ...
                        {if $registerdomainenabled}
                            <label class="radio">
                                <input type="radio" class="icheck-control" name="domainoption" value="register" id="selregister" /><span>{$LANG.cartregisterdomainchoice|sprintf2:$companyname}</span>
                            </label>
                        {/if}
                        {if $transferdomainenabled}
                            <label class="radio">
                                <input type="radio" class="icheck-control" name="domainoption" value="transfer" id="seltransfer" /><span>{$LANG.carttransferdomainchoice|sprintf2:$companyname}</span>
                            </label>
                        {/if}
                        {if $owndomainenabled}
                            <label class="radio">
                                <input type="radio" class="icheck-control" name="domainoption" value="owndomain" id="selowndomain" /><span>{$LANG.cartexistingdomainchoice|sprintf2:$companyname}</span>
                            </label>
                        {/if}
                        {if $subdomains}
                            <label class="radio">
