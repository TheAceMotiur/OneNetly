                    ...
                    <tbody>
                        {foreach $pricing['pricing'] as $tld => $price}
                            <tr>
                                ...
                                <td data-order="{current($price.register)|replace:$WHMCSCurrency.prefix:""|replace:$WHMCSCurrency.suffix:""}">
                                ...
                                <td data-order="{current($price.transfer)|replace:$WHMCSCurrency.prefix:""|replace:$WHMCSCurrency.suffix:""}">
                                ...
                                <td data-order="{current($price.renew)|replace:$WHMCSCurrency.prefix:""|replace:$WHMCSCurrency.suffix:""}">
