      ...
      <div class="grid md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-2">
          ...
          <div class="flex space-x-4 mt-6">
            <a href="https://github.com/TheAceMotiur/OneNetly" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors">
            ...
            <a href="https://twitter.com/onenetly" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><NuxtLink to="/docs" class="text-gray-400 hover:text-white transition-colors">Documentation</NuxtLink></li>
            <li><NuxtLink to="/about" class="text-gray-400 hover:text-white transition-colors">About</NuxtLink></li>
            <li><a href="/#features" class="text-gray-400 hover:text-white transition-colors">Features</a></li>
            <li><a href="/#demo" class="text-gray-400 hover:text-white transition-colors">Live Demo</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><NuxtLink to="/cookies" class="text-gray-400 hover:text-white transition-colors">Cookie Policy</NuxtLink></li>
            <li><a href="https://opensource.org/licenses/MIT" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors">MIT License</a></li>
          </ul>
        </div>
      </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex items-center space-x-4 mt-4 md:mt-0">
            ...
            <div class="flex items-center space-x-2">
              ...
              <span class="text-gray-400 text-xs">All systems operational</span>
            </div>
          </div>
        </div>
      </div>
