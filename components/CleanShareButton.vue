      ...
      >
        ...
        <div class="grid grid-cols-2 gap-3 mb-6">
          <button
            ...
            class="group flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-white to-gray-50 border-2 border-gray-200 hover:border-purple-300 hover:from-purple-50 hover:to-pink-50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg"
          >
        ...
        <div class="mt-6 pt-4 border-t border-gray-200 text-center">
          <p class="text-xs text-gray-500">Powered by OneNetly</p>
        </div>
      </div>
    </transition>
