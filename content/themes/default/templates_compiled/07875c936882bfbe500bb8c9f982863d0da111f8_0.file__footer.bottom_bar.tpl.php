...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_66f92cbd8af062_41535523',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '07875c936882bfbe500bb8c9f982863d0da111f8' => 
    array (
...
function content_66f92cbd8af062_41535523 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"header-home",'class'=>"header-icon ".$_prefixVariable1,'width'=>"24px",'height'=>"24px"), (int) 0, $_smarty_current_dir);
?>
...
$_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"reels",'class'=>"header-icon ".$_prefixVariable2,'width'=>"24px",'height'=>"24px"), (int) 0, $_smarty_current_dir);
?>
...
$_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"watch",'class'=>"header-icon ".$_prefixVariable3,'width'=>"24px",'height'=>"24px"), (int) 0, $_smarty_current_dir);
?>
...
$_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"header-search",'class'=>"header-icon ".$_prefixVariable4,'width'=>"24px",'height'=>"24px"), (int) 0, $_smarty_current_dir);
?>
