<?php
/* Smarty version 4.5.1, created on 2024-09-05 14:41:02
  from '/home/onenetly/public_html/content/themes/default/templates/live.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d9c2fe545291_52065273',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '32e82e1e707ea7a3b9b5047ad586e2874fde8069' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/live.tpl',
      1 => 1698757434,
      2 => 'file',
    ),
  ),
...
function content_66d9c2fe545291_52065273 (Smarty_Internal_Template $_smarty_tpl) {
          ...
          <div class="float-end">
            <?php if (!$_smarty_tpl->tpl_vars['page_id']->value && $_smarty_tpl->tpl_vars['user']->value->_data['can_receive_tip']) {?>
              <span class="x-hidden" id="js_live-tips">
                ...
                <label class="btn btn-md btn-outline-info rounded-pill" for="tips_enabled"> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Enable Tips" ));?>
</label>
              </span>
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['can_be_for_subscriptions']->value) {?>
              <span class="x-hidden" id="js_live-subscriptions">
                ...
                <label class="btn btn-md btn-outline-info rounded-pill" for="for_subscriptions"> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Subscribers Only" ));?>
</label>
              </span>
            <?php }?>
            <span class="btn btn-md btn-danger rounded-pill x-hidden" id="js_live-end"><i class="fas fa-power-off mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "End" ));?>
</span>
...
if ($_smarty_tpl->tpl_vars['event_id']->value) {?> data-node-id=<?php echo $_smarty_tpl->tpl_vars['event_id']->value;?>
 data-node='event' <?php }?>><i class="fas fa-play mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Go Live" ));?>
</span>
          </div>
        </div>
        <!-- live stream title -->
        ...
        <div class="live-stream-video large">
          ...
          <div class="live-counter">
            <span class="status offline" id=js_live-counter-status><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Offline" ));?>
</span>
            <span class="number">
          ...
          <?php if ($_smarty_tpl->tpl_vars['system']->value['save_live_enabled']) {?>
            <div class="live-recording" id="js_live-recording">
              <span>
                <i class="fas fa-record-vinyl mr5"></i><span><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Recording" ));?>
</span>
              </span>
            </div>
          <?php }?>
          ...
          <div class="live-status" id="js_live-status">
            ...
            <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Getting the Camera and Mic permissions" ));?>
