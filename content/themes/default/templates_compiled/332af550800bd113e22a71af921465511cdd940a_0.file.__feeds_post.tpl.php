...
/* Smarty version 4.5.1, created on 2024-08-31 08:00:49
  from '/home/onenetly/public_html/content/themes/default/templates/__feeds_post.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d2cdb1c12376_33425430',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '332af550800bd113e22a71af921465511cdd940a' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/__feeds_post.tpl',
      1 => 1710678913,
      2 => 'file',
    ),
  ),
...
function content_66d2cdb1c12376_33425430 (Smarty_Internal_Template $_smarty_tpl) {
if (!$_smarty_tpl->tpl_vars['standalone']->value) {?><li><?php }?>
  ...
  <div class="post 
                ...
                <?php if (($_smarty_tpl->tpl_vars['post']->value['is_pending']) || ($_smarty_tpl->tpl_vars['post']->value['in_group'] && !$_smarty_tpl->tpl_vars['post']->value['group_approved']) || ($_smarty_tpl->tpl_vars['post']->value['in_event'] && !$_smarty_tpl->tpl_vars['post']->value['event_approved'])) {?>pending<?php }?>
            " data-id="<?php echo $_smarty_tpl->tpl_vars['post']->value['post_id'];?>
">

    <?php if (($_smarty_tpl->tpl_vars['post']->value['is_pending']) || ($_smarty_tpl->tpl_vars['post']->value['in_group'] && !$_smarty_tpl->tpl_vars['post']->value['group_approved']) || ($_smarty_tpl->tpl_vars['post']->value['in_event'] && !$_smarty_tpl->tpl_vars['post']->value['event_approved'])) {?>
...
">
    ...
    <?php if ($_smarty_tpl->tpl_vars['standalone']->value && $_smarty_tpl->tpl_vars['pinned']->value) {?>
      <div class="pin-icon" data-bs-toggle="tooltip" title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Pinned Post" ));?>
">
...
"><?php echo $_smarty_tpl->tpl_vars['post']->value['time'];?>
    ...
    <div class="post-body">
      ...
      <?php if ($_smarty_tpl->tpl_vars['_get']->value == "posts_profile" && $_smarty_tpl->tpl_vars['user']->value->_data['user_id'] == $_smarty_tpl->tpl_vars['post']->value['author_id'] && ($_smarty_tpl->tpl_vars['post']->value['is_hidden'] || $_smarty_tpl->tpl_vars['post']->value['is_anonymous'])) {?>
        <div class="post-top-alert"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Only you can see this post" ));?>
</div>
      <?php }?>
      <!-- post top alert -->
...
?>
      ...
      <?php if (!$_smarty_tpl->tpl_vars['post']->value['needs_payment'] && !$_smarty_tpl->tpl_vars['post']->value['needs_subscription'] && !$_smarty_tpl->tpl_vars['post']->value['needs_pro_package'] && !$_smarty_tpl->tpl_vars['post']->value['needs_age_verification']) {?>
        <!-- post stats -->
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Comments" ));?>
...
">
 ...
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Shares" ));?>
...
">
 ...
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Donations" ));?>
...
">
                <i class="fa fa-star mr5"></i><?php echo $_smarty_tpl->tpl_vars['post']->value['reviews_count'];?>
...
;"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['reactions']->value[$_smarty_tpl->tpl_vars['post']->value['i_reaction']]['title'] ));?>
</span>
                <?php }?>
              </div>
              <!-- reaction-btn -->
...
?>
            ...
            <!-- review -->
            <?php if ($_smarty_tpl->tpl_vars['post']->value['author_id'] != $_smarty_tpl->tpl_vars['user']->value->_data['user_id'] && $_smarty_tpl->tpl_vars['system']->value['posts_reviews_enabled']) {?>
              <div class="action-btn" data-toggle="modal" data-url="modules/review.php?do=review&id=<?php echo $_smarty_tpl->tpl_vars['post']->value['post_id'];?>
&type=post">
                <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"star",'class'=>"action-icon mr5",'width'=>"24px",'height'=>"24px"), 0, true);
?>
                <span class="d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Review" ));?>
</span>
              </div>
            <?php }?>
            <!-- review -->
...
/signin"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Please log in to like, share and comment!" ));?>
    ...
    <?php if (($_smarty_tpl->tpl_vars['post']->value['in_group'] && $_smarty_tpl->tpl_vars['post']->value['is_group_admin'] && !$_smarty_tpl->tpl_vars['post']->value['group_approved']) || ($_smarty_tpl->tpl_vars['post']->value['in_event'] && $_smarty_tpl->tpl_vars['post']->value['is_event_admin'] && !$_smarty_tpl->tpl_vars['post']->value['event_approved'])) {?>
      <div class="post-approval">
        <button class="btn btn-success btn-sm mr5 js_approve-post"><i class="fa fa-check mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Approve" ));?>
</button>
        <button class="btn btn-danger btn-sm js_delete-post"><i class="fa fa-times mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Decline" ));?>
</button>
      </div>
    <?php }?>
    <!-- post approval -->
