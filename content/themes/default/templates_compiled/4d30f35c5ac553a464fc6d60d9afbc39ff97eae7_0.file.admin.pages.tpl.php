<?php
/* Smarty version 4.5.1, created on 2024-08-31 20:56:54
  from '/home/onenetly/public_html/content/themes/default/templates/admin.pages.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d38396f15392_34236745',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4d30f35c5ac553a464fc6d60d9afbc39ff97eae7' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/admin.pages.tpl',
      1 => 1707407595,
      2 => 'file',
    ),
  ),
...
function content_66d38396f15392_34236745 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="card">
...
" class="btn btn-md btn-info">
          <i class="fa fa-eye"></i><span class="ml5 d-none d-lg-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "View Page" ));?>
</span>
        </a>
      </div>
...
/pages/categories" class="btn btn-md btn-light">
    ...
    <?php }?>
    <i class="fa fa-flag mr10"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Pages" ));?>
          ...
          <div class="col-sm-4">
            <div class="stat-panel bg-gradient-primary">
              <div class="stat-cell narrow">
                ...
                <span class="text-lg"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Verified Pages" ));?>
</span><br>
              </div>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="stat-panel bg-gradient-info">
              <div class="stat-cell narrow">
                ...
                <span class="text-lg"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Total Likes" ));?>
</span><br>
              </div>
            </div>
          </div>
...
/pages/find" method="get">
        ...
        <div class="form-text small">
          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search by Page Web Address or Title" ));?>
        ...
        <table class="table table-striped table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Likes" ));?>
</th>
              <th><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Verified" ));?>
</th>
        ...
        <div class="col-12 col-md-10 mb20">
          <ul class="list-group">
            <li class="list-group-item">
              ...
              <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Page ID" ));?>
      ...
      <ul class="nav nav-tabs mb20">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#page_info" data-bs-toggle="tab">
            <i class="fa fa-info-circle fa-fw mr5"></i><strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Info" ));?>
</strong>
          </a>
        </li>
...
" class="btn btn-sm btn-light btn-icon btn-rounded ml10">
            ...
            <div class="row form-group">
              <label class="col-md-3 form-label">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Verified Page" ));?>
            ...
            <div class="row form-group">
              <label class="col-md-3 form-label">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Name Your Page" ));?>
...
">
            ...
            <div class="row form-group">
              <label class="col-md-3 form-label">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Page Username" ));?>
...
/<?php echo $_smarty_tpl->tpl_vars['control_panel']->value['url'];?>
/pages">
                <i class="fa fa-trash-alt mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Delete Page" ));?>
...
&node_type=page" class="payment-plan new"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Add new plan" ));?>
          ...
          <?php } else { ?>
            <div class="alert alert-danger">
              ...
              <div class="text pt5">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "This page super admin is not eligible for monetization" ));?>
