...
/* Smarty version 4.5.1, created on 2024-08-31 08:00:49
  from '/home/onenetly/public_html/content/themes/default/templates/__feeds_comment.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d2cdb1e9a9e8_45793865',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '612e2c33da5b82290945a154a9ad3ed74f443f1a' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/__feeds_comment.tpl',
      1 => 1707407499,
      2 => 'file',
    ),
  ),
...
function content_66d2cdb1e9a9e8_45793865 (Smarty_Internal_Template $_smarty_tpl) {
?><li>
...
"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Report" ));?>
            ...
            <?php } elseif (!$_smarty_tpl->tpl_vars['_comment']->value['edit_comment'] && $_smarty_tpl->tpl_vars['_comment']->value['delete_comment']) {?>
              <div class="dropdown-item pointer js_delete-comment"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Delete Comment" ));?>
</div>
            <?php } else { ?>
              <div class="dropdown-item pointer js_edit-comment"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Edit Comment" ));?>
</div>
              <div class="dropdown-item pointer js_delete-comment"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Delete Comment" ));?>
</div>
            <?php }?>
...
?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['_comment']->value['user_subscribed']) {?>
              <span class="pro-badge" data-bs-toggle="tooltip" title='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['_comment']->value['package_name'] ));?>
...
">
            ...
            <div class="reaction-btn">
              <?php if (!$_smarty_tpl->tpl_vars['_comment']->value['i_react']) {?>
                ...
                <span class="reaction-btn-name text-link"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "React" ));?>
</span>
              <?php } else { ?>
                <div class="reaction-btn-icon d-none">
...
;"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['reactions']->value[$_smarty_tpl->tpl_vars['_comment']->value['i_reaction']]['title'] ));?>
</span>
              <?php }?>
            </div>
            <!-- reaction-btn -->
...
$__foreach_reaction_30_saved = $_smarty_tpl->tpl_vars['reaction'];
?>
...
?>
              ...
              <?php
$_smarty_tpl->tpl_vars['reaction'] = $__foreach_reaction_30_saved;
}
...
echo $_smarty_tpl->tpl_vars['_comment']->value['author_user_name'];
            ...
            <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Reply" ));?>
...
" data-remove="true">
              <span class="text-link">
                ...
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "View previous replies" ));?>
          ...
          <?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>
            <div class="x-hidden js_reply-form">
              <div class="x-form comment-form">
                <textarea dir="auto" class="js_autosize js_mention js_post-reply" rows="1" placeholder='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Write a Reply" ));?>
'></textarea>
