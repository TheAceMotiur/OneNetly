<?php
/* Smarty version 4.5.1, created on 2024-09-05 05:07:18
  from '/home/onenetly/public_html/content/themes/default/templates/admin.groups.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d93c86dd0018_13569573',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '68c8f2c821c4840c4abe8f7c62e75110c5b6080c' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/admin.groups.tpl',
      1 => 1707407729,
      2 => 'file',
    ),
  ),
...
function content_66d93c86dd0018_13569573 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="card">
...
" class="btn btn-md btn-info">
          <i class="fa fa-eye"></i><span class="ml5 d-none d-lg-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "View Group" ));?>
</span>
        </a>
      </div>
...
/groups/categories" class="btn btn-md btn-light">
    ...
    <?php }?>
    <i class="fa fa-users mr10"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Groups" ));?>
...
/groups/find" method="get">
        ...
        <div class="form-text small">
          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search by Group Web Address or Title" ));?>
        ...
        <table class="table table-striped table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Group" ));?>
</th>
              ...
              <th><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Members" ));?>
</th>
        ...
        <div class="col-12 col-md-10 mb20">
          <ul class="list-group">
            <li class="list-group-item">
              ...
              <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Group ID" ));?>
      ...
      <ul class="nav nav-tabs mb20">
        <li class="nav-item">
          <a class="nav-link active" href="#group_settings" data-bs-toggle="tab">
            <i class="fa fa-cog fa-fw mr5"></i><strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Settings" ));?>
</strong>
          </a>
        </li>
        <?php if ($_smarty_tpl->tpl_vars['system']->value['monetization_enabled']) {?>
          <li class="nav-item">
            <a class="nav-link" href="#group_monetization" data-bs-toggle="tab">
              <i class="fa fa-coins fa-fw mr5"></i><strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Monetization" ));?>
</strong>
            </a>
          </li>
        <?php }?>
...
">
            <div class="row form-group">
              <label class="col-md-3 form-label">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Created By" ));?>
...
" class="btn btn-sm btn-light btn-icon btn-rounded ml10">
            ...
            <div class="row form-group">
              <label class="col-md-3 form-label">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Name Your Group" ));?>
...
">
            ...
            <div class="row form-group">
              <label class="col-md-3 form-label">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Group Username" ));?>
            ...
            <div class="row form-group">
              ...
              <div class="col-md-9">
                <select class="form-select" name="privacy">
                  <option <?php if ($_smarty_tpl->tpl_vars['data']->value['group_privacy'] == "public") {?>selected<?php }?> value="public"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Public Group" ));?>
</option>
                  <option <?php if ($_smarty_tpl->tpl_vars['data']->value['group_privacy'] == "closed") {?>selected<?php }?> value="closed"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Closed Group" ));?>
</option>
                  <option <?php if ($_smarty_tpl->tpl_vars['data']->value['group_privacy'] == "secret") {?>selected<?php }?> value="secret"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Secret Group" ));?>
</option>
                </select>
                <div class="form-text">
...
/<?php echo $_smarty_tpl->tpl_vars['control_panel']->value['url'];?>
/groups">
                <i class="fa fa-trash-alt mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Delete Group" ));?>
...
&node_type=group" class="payment-plan new"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Add new plan" ));?>
          ...
          <?php } else { ?>
            <div class="alert alert-danger">
              ...
              <div class="text pt5">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "This group super admin is not eligible for monetization" ));?>
