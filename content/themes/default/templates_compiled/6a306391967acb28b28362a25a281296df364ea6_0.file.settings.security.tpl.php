<?php
/* Smarty version 4.5.1, created on 2024-09-06 23:32:44
  from '/home/onenetly/public_html/content/themes/default/templates/settings.security.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66db911c71b2f6_33092703',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6a306391967acb28b28362a25a281296df364ea6' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/settings.security.tpl',
      1 => 1685364821,
      2 => 'file',
    ),
  ),
...
function content_66db911c71b2f6_33092703 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Change Password" ));?>
  ...
  <form class="js_ajax-forms" data-url="users/settings.php?edit=password">
    <div class="card-body">
      <div class="alert alert-warning">
        ...
        <div class="text pt5">
          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Changing password will log you out from all other sessions" ));?>

        </div>
      </div>

      <div class="form-group">
        <label class="form-label"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Confirm Current Password" ));?>
</label>
      ...
      <div class="row">
        <div class="form-group col-md-6">
          <label class="form-label"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Your New Password" ));?>
</label>
          <input type="password" class="form-control" name="new">
        </div>
        <div class="form-group col-md-6">
          <label class="form-label"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Confirm New Password" ));?>
</label>
  ...
  <div class="card-header with-icon">
    <div class="float-end">
      <button class="btn btn-md btn-danger js_session-delete-all">
        <i class="fa fa-sign-out-alt"></i><span class="ml5 d-none d-lg-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Log Out Of All Sessions" ));?>
</span>
      </button>
    </div>
...
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Manage Sessions" ));?>
...
?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['session']->value['session_id'] == $_smarty_tpl->tpl_vars['user']->value->_data['active_session_id']) {?><span class="badge rounded-pill badge-lg bg-success"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Active Session" ));?>
</span><?php }?>
                </td>
...
<?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "two-factor") {?>
  <div class="card-header with-icon">
    <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"security",'class'=>"main-icon mr15",'width'=>"24px",'height'=>"24px"), 0, true);
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Two-Factor Authentication" ));?>
  ...
  <form class="js_ajax-forms" data-url="users/settings.php?edit=two-factor">
    <div class="card-body">
      <div class="alert alert-info">
        <div class="text">
          <strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Two-Factor Authentication" ));?>
</strong><br>
          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Log in with a code from your" ));?>

          <?php if ($_smarty_tpl->tpl_vars['system']->value['two_factor_type'] == "email") {
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "email" ));
}?>
          <?php if ($_smarty_tpl->tpl_vars['system']->value['two_factor_type'] == "sms") {
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "phone" ));
}?>
          <?php if ($_smarty_tpl->tpl_vars['system']->value['two_factor_type'] == "google") {
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Google Authenticator App" ));
}?>
          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "as well as a password" ));?>
      ...
      <?php if (!$_smarty_tpl->tpl_vars['user']->value->_data['user_two_factor_enabled'] && $_smarty_tpl->tpl_vars['system']->value['two_factor_type'] == "google") {?>
        <div class="heading-small mb20">
          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Configuring your authenticator" ));?>

        </div>
        <div class="pl-md-4">
          <ol class="mtb20">
            <li class="mb5">
              <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "You need to download Google Authenticator app for" ));?>
 <a target="_blank" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Android" ));?>
</a> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "or" ));?>
 <a target="_blank" href="https://itunes.apple.com/eg/app/google-authenticator/id388497605?mt=8"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "IOS" ));?>
</a>
            </li>
            <li>
              <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "In your app, add a new account using the details below" ));?>
:
            </li>
          </ol>
          ...
          <div class="row text-center">
            <div class="form-group col-md-6">
              <h6><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Scanning the QR code" ));?>
</h6>
              <img src="<?php echo $_smarty_tpl->tpl_vars['two_factor_QR']->value;?>
">
            </div>
            <div class="form-group col-md-6">
              <h6><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Manually by entering this token" ));?>
</h6>
              <h3>
        ...
        <div class="heading-small mb20">
          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Activate your authenticator" ));?>

        </div>
        <div class="pl-md-4">
          <div class="row form-group">
            <label class="col-md-3 form-label">
              <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Verification Code" ));?>

            </label>
            <div class="col-md-9">
              <input name="gcode" type="text" class="form-control" placeholder="######" required autofocus>
              <div class="form-text">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Enter the code shown on your app" ));?>
