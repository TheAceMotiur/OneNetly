<?php
/* Smarty version 4.5.1, created on 2024-09-01 20:31:57
  from '/home/onenetly/public_html/content/themes/default/templates/started.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d4cf3d291250_88350624',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '73b0b4ab488441820a46dfd5735697ac8d13a2dd' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/started.tpl',
      1 => 1689526118,
      2 => 'file',
    ),
  ),
...
function content_66d4cf3d291250_88350624 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div class="card-body">
          ...
          <ul class="nav nav-pills nav-fill nav-started mb30 js_wizard-steps">
            <li class="nav-item">
              <a class="nav-link active" href="#step-1">
                <h4 class="mb5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Step 1" ));?>
</h4>
                <p class="mb0"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Upload your photo" ));?>
</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link disabled" href="#step-2">
                <h4 class="mb5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Step 2" ));?>
</h4>
                <p class="mb0"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Update your info" ));?>
</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link disabled" href="#step-3">
                <h4 class="mb5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Step 3" ));?>
</h4>
                <p class="mb0"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Add Friends" ));?>
</p>
              </a>
            </li>
          </ul>
          ...
          <div class="js_wizard-content" id="step-1">
            <div class="text-center">
              <h3 class="mb5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Welcome" ));?>
 <span class="text-primary"><?php echo $_smarty_tpl->tpl_vars['user']->value->_data['name'];?>
</span></h3>
              <p class="mb20"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Let's start with your photo" ));?>
</p>
            </div>
...
"></i>
            ...
            <div class="clearfix mt20">
              <button id="activate-step-2" class="btn btn-primary float-end"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Next Step" ));?>
<i class="fas fa-arrow-circle-right ml5"></i></button>
          ...
          <div class="js_wizard-content x-hidden" id="step-2">
            <div class="text-center">
              <h3 class="mb5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Update your info" ));?>
</h3>
              <p class="mb20"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Share your information with our community" ));?>
</p>
            </div>
                ...
                <?php if ($_smarty_tpl->tpl_vars['system']->value['location_info_enabled']) {?>
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label class="form-label" for="city"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Current City" ));?>
</label>
...
">
                    ...
                    <div class="form-group col-md-6">
                      <label class="form-label" for="hometown"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Hometown" ));?>
</label>
...
">
              ...
              <?php if ($_smarty_tpl->tpl_vars['system']->value['work_info_enabled']) {?>
                ...
                <div class="pl-md-4">
                  <div class="form-group">
                    <label class="form-label" for="work_title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Work Title" ));?>
</label>
...
">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label class="form-label" for="work_place"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Work Place" ));?>
</label>
...
">
                    ...
                    <div class="form-group col-md-6">
                      <label class="form-label" for="work_url"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Work Website" ));?>
</label>
...
">
              ...
              <?php if ($_smarty_tpl->tpl_vars['system']->value['education_info_enabled']) {?>
                ...
                <div class="pl-md-4">
                  <div class="form-group">
                    <label class="form-label" for="edu_major"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Major" ));?>
</label>
...
">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label class="form-label" for="edu_school"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "School" ));?>
</label>
...
">
                    ...
                    <div class="form-group col-md-6">
                      <label class="form-label" for="edu_class"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Class" ));?>
</label>
...
">
              ...
              <div class="clearfix mt20">
                <div class="float-end">
                  <button type="submit" class="btn btn-success"><i class="fas fa-check-circle mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Save Changes" ));?>
</button>
                  <button type="button" class="btn btn-primary" id="activate-step-3"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Next Step" ));?>
<i class="fas fa-arrow-circle-right ml5"></i></button>
                </div>
              </div>
              <!-- buttons -->
          ...
          <div class="js_wizard-content x-hidden" id="step-3">
            <div class="text-center">
              <h3 class="mb5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Add Friends" ));?>
</h3>
              <p class="mb20"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Get latest activities from our popular users" ));?>
</p>
            </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              ...
              <!-- buttons -->
              <div class="clearfix mt20">
                <button type="submit" class="btn btn-danger float-end"><i class="fas fa-check-circle mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Finish" ));?>
</button>
              </div>
              <!-- buttons -->
            </form>
