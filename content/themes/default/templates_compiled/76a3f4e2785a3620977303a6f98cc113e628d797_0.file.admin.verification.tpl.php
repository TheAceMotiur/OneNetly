<?php
/* Smarty version 4.5.1, created on 2024-09-02 09:57:12
  from '/home/onenetly/public_html/content/themes/default/templates/admin.verification.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d58bf828c039_78996991',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '76a3f4e2785a3620977303a6f98cc113e628d797' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/admin.verification.tpl',
      1 => 1707241476,
      2 => 'file',
    ),
  ),
...
function content_66d58bf828c039_78996991 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/onenetly/public_html/vendor/smarty/smarty/libs/plugins/modifier.capitalize.php','function'=>'smarty_modifier_capitalize',),1=>array('file'=>'/home/onenetly/public_html/vendor/smarty/smarty/libs/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
?>
<div class="card">
  <div class="card-header with-icon">
    <i class="fa fa-check-circle mr10"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Verification" ));?>

    <?php if ($_smarty_tpl->tpl_vars['sub_view']->value == '') {?> &rsaquo; <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Requests" ));
}?>
    <?php if ($_smarty_tpl->tpl_vars['sub_view']->value == "users") {?> &rsaquo; <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Verified Users" ));
}?>
    <?php if ($_smarty_tpl->tpl_vars['sub_view']->value == "pages") {?> &rsaquo; <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Verified Pages" ));
}?>
  </div>
        ...
        <table class="table table-striped table-bordered table-hover js_dataTable">
          <thead>
            <tr>
              ...
              <th><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "User/Page" ));?>
</th>
...
"><?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['row']->value['node_type']);?>
                ...
                <td>
                  <button data-bs-toggle="tooltip" title='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "View Verification Documents" ));?>
...
">
                  ...
                  <button data-bs-toggle="tooltip" title='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Verify" ));?>
...
' class="btn btn-sm btn-icon btn-rounded btn-danger js_admin-unverify" data-handle="<?php echo $_smarty_tpl->tpl_vars['row']->value['node_type'];?>
" data-id="<?php echo $_smarty_tpl->tpl_vars['row']->value['node_id'];?>
">
