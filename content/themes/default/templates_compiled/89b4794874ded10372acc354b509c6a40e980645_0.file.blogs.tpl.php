<?php
/* Smarty version 4.5.1, created on 2024-08-31 22:44:41
  from '/home/onenetly/public_html/content/themes/default/templates/blogs.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d39cd9534905_95846731',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '89b4794874ded10372acc354b509c6a40e980645' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/blogs.tpl',
      1 => 1707224932,
      2 => 'file',
    ),
  ),
...
function content_66d39cd9534905_95846731 (Smarty_Internal_Template $_smarty_tpl) {
...
/images/headers/undraw_content_creator_xeju.svg">
    ...
    <div class="<?php if ($_smarty_tpl->tpl_vars['system']->value['fluid_design']) {?>container-fluid<?php } else { ?>container<?php }?>">
      <h2><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Blogs" ));?>
</h2>
      <p class="text-xlg"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['system']->value['system_description_blogs'] ));?>
</p>
      <div class="row mt20">
        <div class="col-sm-9 col-lg-6 mx-sm-auto">
          <form class="js_search-form" data-filter="articles">
            <div class="input-group">
              <input type="text" class="form-control" name="query" placeholder='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search for articles" ));?>
'>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <div class="alert alert-post see-more js_see-more" data-get="articles">
              <span><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "More Articles" ));?>
</span>
...
/blogs/new" class="btn btn-success">
                    <i class="fa fa-edit mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Write New Article" ));?>
...
?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['category']->value['category_description']) {?>
              ...
              <div class="articles-widget-header">
                <div class="articles-widget-title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Description" ));?>
</div>
              </div>
              <div class="mb15">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value['category_description'] ));?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['blogs_categories']->value) {?>
              <!-- blogs categories -->
              <div class="articles-widget-header">
                <div class="articles-widget-title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Sub-Categories" ));?>
</div>
              </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <!-- read more -->
            <div class="articles-widget-header">
              <div class="articles-widget-title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Read More" ));?>
</div>
            </div>
...
?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['article']->value['needs_age_verification']) {?>
              <div class="article-wrapper no-footer">
                <div class="ptb20 plr20">
...
?>
            ...
            <?php } else { ?>
              <div class="article mb20 <?php if (($_smarty_tpl->tpl_vars['article']->value['is_pending']) || ($_smarty_tpl->tpl_vars['article']->value['in_group'] && !$_smarty_tpl->tpl_vars['article']->value['group_approved']) || ($_smarty_tpl->tpl_vars['article']->value['in_event'] && !$_smarty_tpl->tpl_vars['article']->value['event_approved'])) {?>pending<?php }?>" data-id="<?php echo $_smarty_tpl->tpl_vars['article']->value['post_id'];?>
">
                <?php if (($_smarty_tpl->tpl_vars['article']->value['is_pending']) || ($_smarty_tpl->tpl_vars['article']->value['in_group'] && !$_smarty_tpl->tpl_vars['article']->value['group_approved']) || ($_smarty_tpl->tpl_vars['article']->value['in_event'] && !$_smarty_tpl->tpl_vars['article']->value['event_approved'])) {?>
                  <div class="pending-icon" data-bs-toggle="tooltip" title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Pending Post" ));?>
">
...
">
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['article']->value['article']['category_name'] ));?>
...
?>
                        ...
                        <div class="post-time">
                          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Posted" ));?>
...
"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['tag']->value ));?>
</a>
                          </li>
                        <?php
}
...
">
                        ...
                        <div class="reaction-btn">
                          <?php if (!$_smarty_tpl->tpl_vars['article']->value['i_react']) {?>
                            ...
                            <span class="reaction-btn-name d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "React" ));?>
</span>
                          <?php } else { ?>
                            <div class="reaction-btn-icon">
                              <div class="inline-emoji no_animation">
...
"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['reactions']->value[$_smarty_tpl->tpl_vars['article']->value['i_reaction']]['title'] ));?>
</span>
                          <?php }?>
                        </div>
                        <!-- reaction-btn -->
...
" data-title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['reaction']->value['title'] ));?>
">
...
?>
                        <span class="d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Comment" ));?>
</span>
                      </div>
                      <!-- comment -->
...
?>
                          <span class="d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Share" ));?>
</span>
                        </div>
                      <?php }?>
                      <!-- share -->
...
?>
                          <span class="ml5 d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Tip" ));?>
</span>
                        </div>
                      <?php }?>
                      <!-- tips -->
...
?>
                  ...
                  <?php } else { ?>
                    <div class="ptb10">
                      <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/signin"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Please log in to like, share and comment!" ));?>
</a>
                    </div>
                  <?php }?>
                </div>
...
/blogs/new" class="btn btn-success">
            ...
            <!-- search -->
            <div class="articles-widget-header">
              <div class="articles-widget-title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search" ));?>
</div>
            </div>
            <div class="mb10">
              <form class="js_search-form" data-filter="articles">
                <div class="input-group">
                  <input type="text" class="form-control" name="query" placeholder='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search for articles" ));?>
'>
                  <button type="submit" class="btn btn-secondary"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search" ));?>
</button>
                </div>
              </form>
            </div>
...
?>
            ...
            <!-- blogs categories -->
            <div class="articles-widget-header">
              <div class="articles-widget-title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Categories" ));?>
</div>
            </div>
            <ul class="article-categories clearfix">
              <?php
...
?>
            <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Edit Article" ));?>
...
">
              ...
              <div class="row form-group">
                <label class="col-md-2 form-label">
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Cover" ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              ...
              <div class="row form-group">
                <label class="col-md-2 form-label">
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Tags" ));?>
...
">
                  <div class="form-text">
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Type a tag name and press Enter or Comma to add it" ));?>
 ...
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "subscribers only" ));?>
</div>
                  </div>
                  <div class="text-end">
...
">
                <i class="fa fa-trash mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Delete Article" ));?>
      ...
      <div class="col-md-8 col-lg-9 sg-offcanvas-mainbar">
        ...
        <div class="card">
          <div class="card-header with-icon">
            <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"articles",'class'=>"main-icon mr5",'width'=>"24px",'height'=>"24px"), 0, true);
?>
            <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Write New Article" ));?>
          ...
          <div class="js_ajax-forms-html" data-url="posts/article.php?do=create">
            <div class="card-body">
              <div class="row form-group">
                <label class="col-md-2 form-label">
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Publish To" ));?>
...
?>
                      ...
                      <div class="title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Timeline" ));?>
</div>
                    </label>
                    <!-- Timeline -->
                    <!-- Page -->
...
?>
                        ...
                        <div class="title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Page" ));?>
</div>
                      </label>
                    <?php }?>
                    <!-- Page -->
...
?>
                        ...
                        <div class="title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Group" ));?>
</div>
                      </label>
                    <?php }?>
                    <!-- Group -->
...
?>
                        ...
                        <div class="title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Event" ));?>
</div>
                      </label>
                    <?php }?>
                    <!-- Event -->
              ...
              <div id="js_publish-to-page" <?php if ($_smarty_tpl->tpl_vars['share_to']->value != "page") {?>class="x-hidden" <?php }?>>
                <div class="row form-group">
                  <label class="col-md-2 form-label">
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Select Page" ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              ...
              <div id="js_publish-to-group" <?php if ($_smarty_tpl->tpl_vars['share_to']->value != "group") {?>class="x-hidden" <?php }?>>
                <div class="row form-group">
                  <label class="col-md-2 form-label">
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Select Group" ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              ...
              <div id="js_publish-to-event" <?php if ($_smarty_tpl->tpl_vars['share_to']->value != "event") {?>class="x-hidden" <?php }?>>
                <div class="row form-group">
                  <label class="col-md-2 form-label">
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Select Event" ));?>
