<?php
/* Smarty version 4.5.1, created on 2024-08-31 23:32:11
  from '/home/onenetly/public_html/content/themes/default/templates/__feeds_article.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d3a7fbdae611_32075977',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8bf758ba30bb224c6a3915865966f837fbcb5f20' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/__feeds_article.tpl',
      1 => 1706437561,
      2 => 'file',
    ),
  ),
...
function content_66d3a7fbdae611_32075977 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_smarty_tpl->tpl_vars['_tpl']->value == "featured") {?>
  <div class="<?php if ($_smarty_tpl->tpl_vars['_iteration']->value == 1) {?>col-sm-12 col-md-8 col-lg-6<?php } else { ?>col-sm-6 col-md-4 col-lg-3<?php }?>">
    <a href="<?php if ($_smarty_tpl->tpl_vars['article']->value['needs_payment'] || $_smarty_tpl->tpl_vars['article']->value['needs_subscription'] || $_smarty_tpl->tpl_vars['article']->value['needs_pro_package'] || $_smarty_tpl->tpl_vars['article']->value['needs_age_verification']) {
...
/<?php echo $_smarty_tpl->tpl_vars['article']->value['article']['title_url'];
      ...
      <?php if ($_smarty_tpl->tpl_vars['article']->value['needs_payment']) {?>
        <div class="ptb20 plr20">
          <?php $_smarty_tpl->_subTemplateRender('file:_need_payment.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('post_id'=>$_smarty_tpl->tpl_vars['article']->value['post_id'],'price'=>$_smarty_tpl->tpl_vars['article']->value['post_price']), 0, false);
?>
        </div>
...
"><?php echo $_smarty_tpl->tpl_vars['article']->value['time'];?>
      ...
      <?php }?>
      <div class="blog-more">
        <span><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "More" ));?>
</span>
      </div>
    </a>
  </div>
...
">
        <div class="ptb20 plr20">
          <?php $_smarty_tpl->_subTemplateRender('file:_need_age_verification.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </div>
      </a>
    <?php } else { ?>
