...
/* Smarty version 4.5.1, created on 2024-08-31 09:08:42
  from '/home/onenetly/public_html/content/themes/default/templates/ajax.share.publisher.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d2dd9ace86a6_49394637',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9f5f736cfdf70f1a47de71dd539cd56481b1aea8' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/ajax.share.publisher.tpl',
      1 => 1710340511,
      2 => 'file',
    ),
  ),
...
function content_66d2dd9ace86a6_49394637 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  <div class="modal-body">
    ...
    <?php if ($_smarty_tpl->tpl_vars['photo']->value) {?>
      <div class="h6 text-center">
        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Photo link" ));?>
...
'>
      ...
      <?php if ($_smarty_tpl->tpl_vars['system']->value['social_share_enabled']) {?>
        <div class="post-social-share">
          <?php $_smarty_tpl->_subTemplateRender('file:__social_share.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_link'=>((string)$_smarty_tpl->tpl_vars['system']->value['system_url'])."/photos/".((string)$_smarty_tpl->tpl_vars['photo']->value['photo_id'])), 0, false);
?>
        </div>
      <?php }?>

      <div class="h6 text-center">
        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Post link" ));?>
...
'>
    ...
    <?php if ($_smarty_tpl->tpl_vars['system']->value['social_share_enabled']) {?>
      <div class="post-social-share">
        <?php $_smarty_tpl->_subTemplateRender('file:__social_share.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_link'=>((string)$_smarty_tpl->tpl_vars['system']->value['system_url'])."/posts/".((string)$_smarty_tpl->tpl_vars['post']->value['post_id'])), 0, true);
?>
      </div>
    <?php }?>

    <div class="h5 text-center">
      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Share the post to" ));?>
...
?>
    ...
    <div id="js_share-to-page" class="x-hidden">
      <div class="form-group">
        <label class="form-label"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Select Page" ));?>
</label>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div id="js_share-to-group" class="x-hidden">
      <div class="form-group">
        <label class="form-label"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Select Group" ));?>
</label>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div id="js_share-to-event" class="x-hidden">
      <div class="form-group">
        <label class="form-label"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Select Event" ));?>
</label>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
  ...
  <div class="modal-footer">
    <button type="submit" class="btn btn-primary"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Share" ));?>
</button>
  </div>
</form>
