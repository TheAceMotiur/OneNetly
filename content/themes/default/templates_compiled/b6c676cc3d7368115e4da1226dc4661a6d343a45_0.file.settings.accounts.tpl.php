<?php
/* Smarty version 4.5.1, created on 2024-09-05 10:41:21
  from '/home/onenetly/public_html/content/themes/default/templates/settings.accounts.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d98ad1c9c183_29515409',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b6c676cc3d7368115e4da1226dc4661a6d343a45' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/settings.accounts.tpl',
      1 => 1685364226,
      2 => 'file',
    ),
  ),
...
function content_66d98ad1c9c183_29515409 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  <?php if ($_smarty_tpl->tpl_vars['user']->value->_data['user_id'] == $_smarty_tpl->tpl_vars['user']->value->_data['user_master_account']) {?>
    <div class="float-end">
      <button type="button" class="btn btn-md btn-primary" data-toggle="modal" data-url="#account-connector">
        <i class="fa fa-plus-circle"></i><span class="ml5 d-none d-lg-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Connect Account" ));?>
</span>
      </button>
    </div>
  <?php }?>
...
<div class="card-body">
  <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['user']->value->_data['connected_accounts']) > 1) {?>
    <?php if ($_smarty_tpl->tpl_vars['user']->value->_data['user_id'] == $_smarty_tpl->tpl_vars['user']->value->_data['user_master_account']) {?>
      <ul>
        <?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <?php } else { ?>
      <div class="alert alert-info">
        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "You are connected to this account" ));?>
