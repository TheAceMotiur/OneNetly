<?php
/* Smarty version 4.5.1, created on 2024-08-31 08:42:54
  from '/home/onenetly/public_html/content/themes/default/templates/group.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d2d78e80ac33_60898701',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ccd7f10d4a71d6d50fa230e7f9c5f83747b39cfc' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/group.tpl',
      1 => 1710533960,
      2 => 'file',
    ),
  ),
...
function content_66d2d78e80ac33_60898701 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Upload Photo" ));?>

                    </div>
                    <div class="action-desc"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Upload a new photo" ));?>
</div>
                  </div>
                  <!-- upload -->
                  <!-- select -->
...
?>
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Select Photo" ));?>

                    </div>
                    <div class="action-desc"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Select a photo" ));?>
</div>
                  </div>
                  <!-- select -->
                </div>
...
"></i>
            ...
            <div class="profile-cover-position-loader">
              <i class="fa fa-arrows-alt mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Drag to reposition cover" ));?>
...
"><?php echo $_smarty_tpl->tpl_vars['group']->value['group_title'];?>
          ...
          <?php if ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "public") {?>
            <i data-bs-toggle="tooltip" title='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Public Group" ));?>
' class="fa fa-globe fa-fw privacy-badge"></i>
          <?php } elseif ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "closed") {?>
            <i data-bs-toggle="tooltip" title='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Closed Group" ));?>
' class="fa fa-unlock-alt fa-fw privacy-badge"></i>
          <?php } elseif ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "secret") {?>
            <i data-bs-toggle="tooltip" title='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Secret Group" ));?>
...
">
              ...
              <span class="d-none d-xxl-inline-block ml5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Joined" ));?>
</span>
            </button>
...
">
              ...
              <span class="d-none d-xxl-inline-block ml5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Pending" ));?>
</span>
            </button>
          <?php } else { ?>
...
echo $_smarty_tpl->tpl_vars['group']->value['group_privacy'];
              ...
              <span class="d-none d-xxl-inline-block ml5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Join" ));?>
</span>
            </button>
          <?php }?>
          <!-- join -->
          ...
          <!-- review -->
          <?php if ($_smarty_tpl->tpl_vars['system']->value['groups_reviews_enabled']) {?>
            <?php if (!$_smarty_tpl->tpl_vars['group']->value['i_admin']) {?>
              <button type="button" class="btn btn-md rounded-pill btn-light" data-toggle="modal" data-url="modules/review.php?do=review&id=<?php echo $_smarty_tpl->tpl_vars['group']->value['group_id'];?>
&type=group">
                <i class="fa fa-star"></i>
                <span class="d-none d-xxl-inline-block ml5"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Review" ));?>
</span>
              </button>
            <?php }?>
          <?php }?>
          ...
          <div class="d-inline-block dropdown ml5">
            ...
            <div class="dropdown-menu dropdown-menu-end action-dropdown-menu">
              <!-- share -->
              <div class="dropdown-item pointer" data-toggle="modal" data-url="modules/share.php?node_type=group&node_username=<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
">
                <div class="action">
...
?>
                ...
                <div class="action-desc"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Share this group" ));?>
</div>
              </div>
              <!-- share -->
              <?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in && !$_smarty_tpl->tpl_vars['group']->value['i_admin']) {?>
                <!-- report -->
...
?>
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Report" ));?>

                  </div>
                  <div class="action-desc"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Report this to admins" ));?>
</div>
                </div>
                <!-- report -->
                <!-- manage -->
...
?>
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Edit in Admin Panel" ));?>
...
">
                    <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"edit_profile",'class'=>"main-icon mr10",'width'=>"20px",'height'=>"20px"), 0, true);
?>
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Edit in Moderator Panel" ));?>
      ...
      <div class="profile-tabs-wrapper d-flex justify-content-evenly">
        <?php if ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "closed" && $_smarty_tpl->tpl_vars['group']->value['i_joined'] != "approved" && !$_smarty_tpl->tpl_vars['group']->value['i_admin'] && !$_smarty_tpl->tpl_vars['user']->value->_is_admin && !$_smarty_tpl->tpl_vars['user']->value->_is_moderator) {?>
          <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
">
...
?>
            <span class="ml5 d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "About" ));?>
</span>
          </a>
        <?php } else { ?>
          <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
...
?>
            <span class="ml5 d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Timeline" ));?>
</span>
          </a>
          <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
...
?>
            <span class="ml5 d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Photos" ));?>
</span>
          </a>
...
?>
              <span class="ml5 d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Videos" ));?>
</span>
            </a>
          <?php }?>
          <?php if ($_smarty_tpl->tpl_vars['system']->value['groups_reviews_enabled']) {?>
...
?>
              <span class="ml5 d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Reviews" ));?>
 <?php if ($_smarty_tpl->tpl_vars['group']->value['group_rate']) {?><span class="badge bg-light text-primary"><?php echo smarty_modifier_number_format($_smarty_tpl->tpl_vars['group']->value['group_rate'],1);?>
</span><?php }?></span>
            </a>
          <?php }?>
          <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
...
?>
            <span class="ml5 d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Members" ));?>
</span>
          </a>
          <?php if ($_smarty_tpl->tpl_vars['group']->value['i_admin']) {?>
            <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
...
?>
              <span class="ml5 d-none d-xl-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Settings" ));?>
</span>
            </a>
          <?php }?>
        <?php }?>
      ...
      <div class="row">
        ...
        <?php if ($_smarty_tpl->tpl_vars['view']->value == '') {?>
          ...
          <!-- left panel -->
          <div class="<?php if ($_smarty_tpl->tpl_vars['group']->value['chatbox_enabled']) {?>col-lg-3 order-3 order-lg-1<?php } else { ?>col-lg-4 order-2 order-lg-1<?php }?>">
...
?>
            ...
            <div class="card">
              <div class="card-body">
                <?php if (!call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'is_empty' ][ 0 ], array( $_smarty_tpl->tpl_vars['group']->value['group_description'] ))) {?>
                  <div class="about-bio">
...
?>
                      <?php if ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "public") {?>
                        ...
                        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Public Group" ));?>

                      <?php } elseif ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "closed") {?>
                        <i class="fa fa-unlock-alt fa-fw"></i>
                        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Closed Group" ));?>

                      <?php } elseif ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "secret") {?>
                        <i class="fa fa-lock fa-fw"></i>
                        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Secret Group" ));?>
...
?>
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['group']->value['posts_count'] ));?>
...
?>
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['group']->value['photos_count'] ));?>
...
?>
                        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['group']->value['videos_count'] ));?>
...
?>
                        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['group']->value['reviews_count'] ));?>
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Reviews" ));?>

                        <?php if ($_smarty_tpl->tpl_vars['group']->value['group_rate']) {?>
                          <span class="review-stars small ml5">
                            <i class="fa fa-star <?php if ($_smarty_tpl->tpl_vars['group']->value['group_rate'] >= 1) {?>checked<?php }?>"></i>
                            <i class="fa fa-star <?php if ($_smarty_tpl->tpl_vars['group']->value['group_rate'] >= 2) {?>checked<?php }?>"></i>
                            <i class="fa fa-star <?php if ($_smarty_tpl->tpl_vars['group']->value['group_rate'] >= 3) {?>checked<?php }?>"></i>
                            <i class="fa fa-star <?php if ($_smarty_tpl->tpl_vars['group']->value['group_rate'] >= 4) {?>checked<?php }?>"></i>
                            <i class="fa fa-star <?php if ($_smarty_tpl->tpl_vars['group']->value['group_rate'] >= 5) {?>checked<?php }?>"></i>
                          </span>
                          <span class="badge bg-light text-primary"><?php echo smarty_modifier_number_format($_smarty_tpl->tpl_vars['group']->value['group_rate'],1);?>
</span>
                        <?php }?>
                      </div>
                    </li>
...
?>
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['group']->value['group_category_name'] ));?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['custom_fields']->value['basic']) {?>
              <div class="card">
                <div class="card-header bg-transparent">
                  <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"info",'class'=>"main-icon mr5",'width'=>"24px",'height'=>"24px"), 0, true);
?>
                  <strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Info" ));?>
</strong>
                </div>
                <div class="card-body">
                  <ul class="about-list">
...
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/subscribers"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Subscribers" ));?>
</a></strong>
...
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/invites"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "See All" ));?>
</a></small>
                  </div>
                  <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"friends",'class'=>"main-icon mr5",'width'=>"24px",'height'=>"24px"), 0, true);
?>
                  <strong><a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/invites"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Invite Friends" ));?>
</a></strong>
                </div>
                <div class="card-body">
                  <ul>
...
?>
                  <strong><a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/photos"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Photos" ));?>
</a></strong>
                </div>
                <div class="card-body">
                  <div class="row">
...
?>
          ...
          <!-- right panel -->
          <div class="<?php if ($_smarty_tpl->tpl_vars['group']->value['chatbox_enabled']) {?>col-lg-6 order-1 order-lg-2<?php } else { ?>col-lg-8 order-1 order-lg-2<?php }?>">
            ...
            <?php if ($_smarty_tpl->tpl_vars['user']->value->_data['user_group'] < 3 && ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "secret" || $_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "closed") && ($_smarty_tpl->tpl_vars['group']->value['i_joined'] != "approved" && !$_smarty_tpl->tpl_vars['group']->value['i_admin'])) {?>
              <div class="alert alert-warning">
                ...
                <div class="text align-middle">
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "You can access this as your account is system admin account!" ));?>
...
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "person" ));
} else {
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "persons" ));
}?> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "wants to join this group" ));?>
...
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "post" ));
} else {
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "posts" ));
}?> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "pending needs your approval" ));?>
...
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "posts" ));
}?> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "pending" ));?>
              ...
              <?php if ($_smarty_tpl->tpl_vars['group']->value['i_joined'] == "approved" && ($_smarty_tpl->tpl_vars['group']->value['group_publish_enabled'] || (!$_smarty_tpl->tpl_vars['group']->value['group_publish_enabled'] && $_smarty_tpl->tpl_vars['group']->value['i_admin']))) {?>
                <?php $_smarty_tpl->_subTemplateRender('file:_publisher.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_handle'=>"group",'_id'=>$_smarty_tpl->tpl_vars['group']->value['group_id'],'_node_can_monetize_content'=>$_smarty_tpl->tpl_vars['group']->value['can_monetize_content'],'_node_monetization_enabled'=>$_smarty_tpl->tpl_vars['group']->value['group_monetization_enabled'],'_node_monetization_plans'=>$_smarty_tpl->tpl_vars['group']->value['group_monetization_plans']), 0, false);
?>
              <?php }?>
              <!-- publisher -->
...
?>
            ...
            <?php } else { ?>
              <!-- posts -->
              <?php $_smarty_tpl->_subTemplateRender('file:_posts.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_get'=>$_smarty_tpl->tpl_vars['get']->value,'_id'=>$_smarty_tpl->tpl_vars['group']->value['group_id'],'_title'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Pending Posts" ))), 0, true);
?>
              <!-- posts -->
            <?php }?>
          </div>
          ...
          <!-- chatbox -->
          <?php if ($_smarty_tpl->tpl_vars['group']->value['chatbox_enabled']) {?>
            <div class="col-lg-3 order-2 order-lg-3">
              <?php $_smarty_tpl->_subTemplateRender('file:_chatbox.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_node_type'=>"group",'_node'=>$_smarty_tpl->tpl_vars['group']->value), 0, false);
?>
            </div>
          <?php }?>
          <!-- chatbox -->
...
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/albums"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Albums" ));?>
</a>
                    </li>
                  </ul>
                  <!-- panel nav -->
...
" data-type='group'>
                  ...
                  <?php } else { ?>
                    <p class="text-center text-muted mt10">
                      <?php echo $_smarty_tpl->tpl_vars['group']->value['group_title'];?>
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "doesn't have photos" ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['group']->value['albums']) >= $_smarty_tpl->tpl_vars['system']->value['max_results_even']) {?>
                      <!-- see-more -->
...
" data-type='group'>
                  ...
                  <?php } else { ?>
                    <p class="text-center text-muted mt10">
                      <?php echo $_smarty_tpl->tpl_vars['group']->value['group_title'];?>
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "doesn't have albums" ));?>
...
/albums" class="btn btn-md btn-light">
                      <i class="fa fa-arrow-circle-left mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Back to Albums" ));?>
...
" data-type='group'>
                  ...
                  <?php } else { ?>
                    <p class="text-center text-muted mt10">
                      <?php echo $_smarty_tpl->tpl_vars['group']->value['group_title'];?>
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "doesn't have videos" ));?>
...
?>
              ...
              <div class="card-body pb0">
                <?php if ($_smarty_tpl->tpl_vars['group']->value['reviews_count'] > 0) {?>
                  <ul class="row">
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['group']->value['reviews'], '_review');
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                  ...
                  <?php if ($_smarty_tpl->tpl_vars['group']->value['reviews_count'] >= $_smarty_tpl->tpl_vars['system']->value['max_results_even']) {?>
                    <!-- see-more -->
                    <div class="alert alert-post see-more mt0 mb20 js_see-more" data-get="reviews" data-id="<?php echo $_smarty_tpl->tpl_vars['group']->value['group_id'];?>
" data-type="group">
                      <span><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "See More" ));?>
</span>
                      <div class="loader loader_small x-hidden"></div>
...
/members">
                  ...
                  <?php if ($_smarty_tpl->tpl_vars['group']->value['has_subscriptions_plans']) {?>
                    <li class="nav-item">
                      <a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/subscribers"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Subscribers" ));?>
                  ...
                  <?php if ($_smarty_tpl->tpl_vars['group']->value['i_joined'] == "approved") {?>
                    <li class="nav-item">
                      <a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/invites"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Invites" ));?>
</a>
                    </li>
                  <?php }?>
                </ul>
...
">
                ...
                <?php } else { ?>
                  <p class="text-center text-muted mt10">
                    <?php echo $_smarty_tpl->tpl_vars['group']->value['group_title'];?>
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "doesn't have members" ));?>
            ...
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <div class="mb20">
                  <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"friends",'class'=>"main-icon mr10",'width'=>"24px",'height'=>"24px"), 0, true);
?>
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Subscribers" ));?>
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/members"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Members" ));?>
</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                  ...
                  <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['group']->value['subscribers']) >= $_smarty_tpl->tpl_vars['system']->value['max_results_even']) {?>
                    <!-- see-more -->
...
" data-type="group">
                ...
                <?php } else { ?>
                  <p class="text-center text-muted mt10">
                    <?php echo $_smarty_tpl->tpl_vars['group']->value['group_title'];?>
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "doesn't have subscribers" ));?>
            ...
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <div class="mb20">
                  <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"friends",'class'=>"main-icon mr10",'width'=>"24px",'height'=>"24px"), 0, true);
?>
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Invites" ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                  ...
                  <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['group']->value['invites']) >= $_smarty_tpl->tpl_vars['system']->value['max_results_even']) {?>
                    <!-- see-more -->
...
">
                ...
                <?php } else { ?>
                  <p class="text-center text-muted mt10">
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "No friends to invite" ));?>
...
?>
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Group Settings" ));?>
...
/settings/requests">
                        <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"friends",'class'=>"main-icon mr10",'width'=>"24px",'height'=>"24px"), 0, true);
?>
                        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Join Requests" ));?>
...
?>
                        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Delete Group" ));?>
...
?>
                ...
                <form class="js_ajax-forms" data-url="modules/create.php?type=group&do=edit&edit=settings&id=<?php echo $_smarty_tpl->tpl_vars['group']->value['group_id'];?>
">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title" id="title" placeholder='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Name of your group" ));?>
...
">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-select" name="privacy">
                        <option <?php if ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "public") {?>selected<?php }?> value="public"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Public Group" ));?>
</option>
                        <option <?php if ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "closed") {?>selected<?php }?> value="closed"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Closed Group" ));?>
</option>
                        <option <?php if ($_smarty_tpl->tpl_vars['group']->value['group_privacy'] == "secret") {?>selected<?php }?> value="secret"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Secret Group" ));?>
</option>
                      </select>
                      <div class="form-text">
                        (<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Note: Change group privacy to public will approve any pending join requests" ));?>
)
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Category" ));?>
</label>
...
?>
                      ...
                      <div>
                        ...
                        <div class="form-text d-none d-sm-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Enable chat box for this group" ));?>
</div>
                      </div>
                      <div class="text-end">
                        <label class="switch" for="chatbox_enabled">
                          <input type="checkbox" name="chatbox_enabled" id="chatbox_enabled" <?php if ($_smarty_tpl->tpl_vars['group']->value['chatbox_enabled']) {?>checked<?php }?>>
                    ...
                    <div class="form-table-row">
                      <div>
                        ...
                        <div class="form-text d-none d-sm-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Members can publish posts or only group admins" ));?>
</div>
                      </div>
                      <div class="text-end">
                    ...
                    <div class="form-table-row">
                      <div>
                        ...
                        <div class="form-text d-none d-sm-block">
                          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "All posts must be approved by a group admin" ));?>
<br>
              ...
              <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "requests") {?>
                <div class="card-header with-icon">
                  <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"friends",'class'=>"main-icon mr10",'width'=>"24px",'height'=>"24px"), 0, true);
?>
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Member Requests" ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['group']->value['requests']) >= $_smarty_tpl->tpl_vars['system']->value['max_results']) {?>
                      <!-- see-more -->
...
">
                  ...
                  <?php } else { ?>
                    <p class="text-center text-muted mt10">
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "No Requests" ));?>
...
?>
                ...
                <div class="card-body">
                  ...
                  <div class="heading-small mb20">
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Admins" ));?>
...
">
                    ...
                    <?php } else { ?>
                      <p class="text-center text-muted mt10">
                        <?php echo $_smarty_tpl->tpl_vars['group']->value['group_title'];?>
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "doesn't have admins" ));?>
                  ...
                  <!-- members -->
                  <div class="heading-small mb20">
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "All Members" ));?>
...
?>
                ...
                <div class="card-body">
                  <div class="alert alert-primary">
                    <div class="text">
                      <strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Monetization" ));?>
</strong><br>
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Now you can earn money from your content. Via paid posts or subscriptions plans." ));?>

                      <br>
                      <?php if ($_smarty_tpl->tpl_vars['system']->value['monetization_commission'] > 0) {?>
                        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "There is commission" ));?>
 <strong><span class="badge rounded-pill bg-warning"><?php echo $_smarty_tpl->tpl_vars['system']->value['monetization_commission'];?>
%</span></strong> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "will be deducted" ));?>
.
                        <br>
                      <?php }?>
                      <?php if ($_smarty_tpl->tpl_vars['system']->value['monetization_money_withdraw_enabled']) {?>
                        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "You can" ));?>
 <a class="alert-link" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/monetization/payments" target="_blank"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "withdraw your money" ));?>
</a>
                      <?php }?>
...
/wallet" target="_blank"><i class="fa fa-wallet"></i> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "wallet" ));?>
                  ...
                  <div class="alert alert-info">
                    ...
                    <div class="text pt5">
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Only super admin can manage monetization and money goes to his monetization money balance" ));?>
.
                    </div>
                  </div>
                  ...
                  <div class="pl-md-4">
                    <form class="js_ajax-forms" data-url="modules/create.php?type=group&do=edit&edit=monetization&id=<?php echo $_smarty_tpl->tpl_vars['group']->value['group_id'];?>
">
                      <div class="form-table-row">
                        <div class="avatar">
...
?>
                      ...
                      <div class="form-group row">
                        <label class="col-md-3 form-label">
                          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Subscriptions Plans" ));?>
...
&node_type=group" class="payment-plan new"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Add new plan" ));?>
 </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="section-title mb20">
                          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Group Subscribers" ));?>
                      ...
                      <div class="col-sm-6">
                        <div class="section-title mb20">
                          <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Monetization Money Balance" ));?>
                        ...
                        <div class="stat-panel bg-gradient-primary">
                          <div class="stat-cell">
                            ...
                            <div class="h3 mtb10">
                              <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'print_money' ][ 0 ], array( smarty_modifier_number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_monetization_balance'],2) ));?>
...
?>
                ...
                <div class="card-body">
                  <div class="alert alert-warning">
                    ...
                    <div class="text pt5">
                      <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Once you delete your group you will no longer can access it again" ));?>
