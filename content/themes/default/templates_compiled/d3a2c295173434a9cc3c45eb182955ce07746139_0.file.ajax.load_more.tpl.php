<?php
/* Smarty version 4.5.1, created on 2024-08-31 08:09:53
  from '/home/onenetly/public_html/content/themes/default/templates/ajax.load_more.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d2cfd1d02932_52314016',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd3a2c295173434a9cc3c45eb182955ce07746139' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/ajax.load_more.tpl',
      1 => 1713439535,
      2 => 'file',
    ),
  ),
...
function content_66d2cfd1d02932_52314016 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php } elseif ($_smarty_tpl->tpl_vars['get']->value == 'products') {?>
  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data']->value, 'post');
$_smarty_tpl->tpl_vars['post']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['post']->value) {
...
?>
    <?php if ($_smarty_tpl->tpl_vars['type']->value == "user") {?>
      <?php $_smarty_tpl->_subTemplateRender('file:__feeds_photo.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_context'=>$_smarty_tpl->tpl_vars['context']->value,'_can_pin'=>true), 0, true);
?>
    <?php } else { ?>
...
$_smarty_tpl->tpl_vars['_user']->do_else = false;
?>
    <?php $_smarty_tpl->_subTemplateRender('file:__feeds_user.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_tpl'=>"box",'_darker'=>true,'_connection'=>$_smarty_tpl->tpl_vars['_user']->value["connection"]), 0, true);
?>
  <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
<?php } elseif ($_smarty_tpl->tpl_vars['get']->value == 'subscriptions') {?>
  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data']->value, '_subscription');
...
<?php } elseif ($_smarty_tpl->tpl_vars['get']->value == 'pages' || $_smarty_tpl->tpl_vars['get']->value == 'suggested_pages' || $_smarty_tpl->tpl_vars['get']->value == 'category_pages' || $_smarty_tpl->tpl_vars['get']->value == 'liked_pages') {?>
  <?php
...
<?php } elseif ($_smarty_tpl->tpl_vars['get']->value == 'groups' || $_smarty_tpl->tpl_vars['get']->value == 'suggested_groups' || $_smarty_tpl->tpl_vars['get']->value == 'category_groups' || $_smarty_tpl->tpl_vars['get']->value == 'joined_groups') {?>
  <?php
...
<?php } elseif ($_smarty_tpl->tpl_vars['get']->value == 'events' || $_smarty_tpl->tpl_vars['get']->value == 'suggested_events' || $_smarty_tpl->tpl_vars['get']->value == 'category_events' || $_smarty_tpl->tpl_vars['get']->value == 'going_events' || $_smarty_tpl->tpl_vars['get']->value == 'interested_events' || $_smarty_tpl->tpl_vars['get']->value == 'invited_events') {?>
  <?php
...
<?php } elseif ($_smarty_tpl->tpl_vars['get']->value == 'profile_events' || $_smarty_tpl->tpl_vars['get']->value == 'page_events') {?>
  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data']->value, '_event');
$_smarty_tpl->tpl_vars['_event']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['_event']->value) {
...
<?php } elseif ($_smarty_tpl->tpl_vars['get']->value == 'orders') {?>
  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data']->value, 'order');
...
<?php } elseif ($_smarty_tpl->tpl_vars['get']->value == 'sales_orders') {?>
  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data']->value, 'order');
$_smarty_tpl->tpl_vars['order']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['order']->value) {
...
<?php } elseif ($_smarty_tpl->tpl_vars['get']->value == 'reviews') {?>
  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data']->value, '_review');
