<?php
/* Smarty version 4.5.1, created on 2024-08-31 11:44:28
  from '/home/onenetly/public_html/content/themes/default/templates/search.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d3021c0d3153_55726833',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dd0219cbb25fc9a3243835cd1ec670c7844a3a7c' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/search.tpl',
      1 => 1708186628,
      2 => 'file',
    ),
  ),
...
function content_66d3021c0d3153_55726833 (Smarty_Internal_Template $_smarty_tpl) {
...
/images/headers/undraw_file_searching_duff.svg">
  ...
  <div class="inner">
    <h2><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search" ));?>
</h2>
    <p class="text-xlg"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Discover new people, create new connections and make new friends" ));?>
</p>
  </div>
</div>
<!-- page header -->
...
" <?php }?>>
            <div class="form-group mb0">
              <div class="input-group">
                <input type="text" class="form-control" name="query" placeholder='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search" ));?>
' <?php if ($_smarty_tpl->tpl_vars['query']->value) {?> value="<?php echo $_smarty_tpl->tpl_vars['query']->value;?>
" <?php }?>>
                <button type="submit" name="submit" class="btn btn-light plr30"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search" ));?>
</button>
              </div>
            </div>
          </form>
...
/posts<?php }?>">
                <strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Posts" ));?>
</strong>
              </a>
            </li>
...
echo $_smarty_tpl->tpl_vars['query']->value;?>
/articles<?php }?>">
                  <strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Articles" ));?>
</strong>
                </a>
              </li>
            <?php }?>
...
echo $_smarty_tpl->tpl_vars['query']->value;?>
/users<?php }?>">
                <strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Users" ));?>
</strong>
              </a>
            </li>
...
echo $_smarty_tpl->tpl_vars['query']->value;?>
/pages<?php }?>">
                  <strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Pages" ));?>
</strong>
                </a>
              </li>
            <?php }?>
...
echo $_smarty_tpl->tpl_vars['query']->value;?>
/groups<?php }?>">
                  <strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Groups" ));?>
</strong>
                </a>
              </li>
            <?php }?>
...
echo $_smarty_tpl->tpl_vars['query']->value;?>
/events<?php }?>">
                  <strong><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Events" ));?>
</strong>
                </a>
              </li>
            <?php }?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                ...
                <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['results']->value) >= $_smarty_tpl->tpl_vars['system']->value['search_results']) {?>
                  <!-- see-more -->
...
">
                    <span><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "More Results" ));?>
</span>
