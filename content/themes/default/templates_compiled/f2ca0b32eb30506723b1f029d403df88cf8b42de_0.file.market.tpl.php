<?php
/* Smarty version 4.5.1, created on 2024-09-01 08:37:40
  from '/home/onenetly/public_html/content/themes/default/templates/market.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.1',
  'unifunc' => 'content_66d427d4da5657_48290787',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f2ca0b32eb30506723b1f029d403df88cf8b42de' => 
    array (
      0 => '/home/onenetly/public_html/content/themes/default/templates/market.tpl',
      1 => 1711969029,
      2 => 'file',
    ),
  ),
...
function content_66d427d4da5657_48290787 (Smarty_Internal_Template $_smarty_tpl) {
...
/images/headers/undraw_online_shopping_ga73.svg">
  ...
  <div class="<?php if ($_smarty_tpl->tpl_vars['system']->value['fluid_design']) {?>container-fluid<?php } else { ?>container<?php }?>">
    <h2><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Marketplace" ));?>
</h2>
    <p class="text-xlg"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( $_smarty_tpl->tpl_vars['system']->value['system_description_marketplace'] ));?>
</p>
    <div class="row mt20">
      <div class="col-sm-9 col-lg-6 mx-sm-auto">
        <form class="js_search-form" data-handle="market">
          <div class="input-group">
            <input type="text" class="form-control" name="query" placeholder='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search for products" ));?>
'>
...
?>
            <span class="ml5 d-none d-lg-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Market" ));?>
</span>
          </a>
        </li>
        <?php if ($_smarty_tpl->tpl_vars['system']->value['market_shopping_cart_enabled'] && $_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>
...
?>
              <span class="ml5 d-none d-lg-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Shopping Cart" ));?>
</span>
            </a>
          </li>
...
?>
              <span class="ml5 d-none d-lg-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Orders" ));?>
</span>
            </a>
          </li>
...
?>
                <span class="ml5 d-none d-lg-inline-block"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Sales" ));?>
</span>
              </a>
            </li>
          <?php }?>
      ...
      <?php if ($_smarty_tpl->tpl_vars['user']->value->_data['can_sell_products']) {?>
        <div class="mt10 float-end">
          <button class="btn btn-md btn-primary d-none d-lg-block" data-toggle="modal" data-url="posts/product.php?do=create">
            <i class="fa fa-plus-circle mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Sell New Product" ));?>
...
</span> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "results were found for the search for" ));?>
 "<strong class="text-primary"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'htmlentities' ][ 0 ], array( $_smarty_tpl->tpl_vars['query']->value,ENT_QUOTES,'utf-8' ));?>
</strong>"
            <!-- results counter -->
          </div>
        <?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['view']->value == '' && $_smarty_tpl->tpl_vars['promoted_products']->value) {?>
          <div class="articles-widget-header">
            <div class="articles-widget-title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Promoted Products" ));?>
</div>
          </div>
          <div class="row mb20">
            <?php
              ...
              <div class="dropdown">
                <button type="button" class="btn btn-sm btn-light dropdown-toggle ml10" data-bs-toggle="dropdown" data-display="static">
                  <?php if (!$_smarty_tpl->tpl_vars['sort']->value || $_smarty_tpl->tpl_vars['sort']->value == "latest") {?>
                    <i class="fas fa-bars fa-fw"></i> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Latest" ));?>

                  <?php } elseif ($_smarty_tpl->tpl_vars['sort']->value == "price-high") {?>
                    <i class="fas fa-sort-amount-down fa-fw"></i> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Price High" ));?>

                  <?php } elseif ($_smarty_tpl->tpl_vars['sort']->value == "price-low") {?>
                    <i class="fas fa-sort-amount-down-alt fa-fw"></i> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Price Low" ));?>

                  <?php }?>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                  <a href="?<?php if ($_smarty_tpl->tpl_vars['distance']->value) {?>distance=<?php echo $_smarty_tpl->tpl_vars['distance']->value;?>
&<?php }?>sort=latest" class="dropdown-item"><i class="fas fa-bars fa-fw mr10"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Latest" ));?>
</a>
                  <a href="?<?php if ($_smarty_tpl->tpl_vars['distance']->value) {?>distance=<?php echo $_smarty_tpl->tpl_vars['distance']->value;?>
&<?php }?>sort=price-high" class="dropdown-item"><i class="fas fa-sort-amount-down fa-fw mr10"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Price High" ));?>
</a>
                  <a href="?<?php if ($_smarty_tpl->tpl_vars['distance']->value) {?>distance=<?php echo $_smarty_tpl->tpl_vars['distance']->value;?>
&<?php }?>sort=price-low" class="dropdown-item"><i class="fas fa-sort-amount-down-alt fa-fw mr10"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Price Low" ));?>
</a>
                </div>
              </div>
            </div>
              ...
              <div class="float-end">
                <div class="dropdown">
                  <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-bs-toggle="dropdown" data-display="static">
                    <i class="fa fa-map-marker-alt mr5"></i><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Location" ));?>
...
echo $_smarty_tpl->tpl_vars['distance']->value;
                      ...
                      <div class="d-grid">
                        <button type="submit" class="btn btn-md btn-primary"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Filter" ));?>
</button>
                      </div>
                    </form>
                  </div>
              ...
              <!-- location filter -->
            <?php }?>
            <div class="articles-widget-title"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Products" ));?>
</div>
          </div>
  ...
  <?php } elseif ($_smarty_tpl->tpl_vars['view']->value == "cart") {?>
    ...
    <div class="card">
      <div class="card-header with-icon">
        <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"products",'class'=>"main-icon mr10",'width'=>"24px",'height'=>"24px"), 0, true);
?>
        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Shopping Cart" ));?>
                        ...
                        <div class="product-image">
                          <div class="product-price">
                            <?php if ($_smarty_tpl->tpl_vars['cart_item']->value['post']['product']['price'] > 0) {?>
                              <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'print_money' ][ 0 ], array( $_smarty_tpl->tpl_vars['cart_item']->value['post']['product']['price'] ));?>
...
" class="title"><?php echo $_smarty_tpl->tpl_vars['cart_item']->value['post']['product']['name'];?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['cart_item']->value['post']['product']['is_digital']) {?>
                          ...
                          <div class="mt20">
                            <div class="form-group">
                              <div class="input-group">
                                <span class="input-group-text"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Qty:" ));?>
</span>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              ...
              <?php } else { ?>
                <div class="alert alert-info">
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Your cart is empty." ));?>

                </div>
              <?php }?>
            </div>
            <div class="heading-small mb20">
              <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Shipping Address" ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                ...
                <div class="alert alert-danger mt15 mb0 x-hidden" id="addresses-error">
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Select a shipping address" ));?>

                </div>
                <!-- error -->
              <?php } else { ?>
                <div class="alert alert-warning">
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "You have no addresses" ));?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['user']->value->_data['user_wallet_balance'] < $_smarty_tpl->tpl_vars['cart']->value['total']) {?>
              <div class="alert alert-warning mt15 d-block">
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Your wallet balance is insufficient" ));?>
. <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/wallet"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Please add funds to continue" ));?>
</a>
              </div>
            <?php }?>
            <div class="text-end">
              <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Total Price" ));?>

              <p>
                <span class="text-xxlg">
                  <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'print_money' ][ 0 ], array( smarty_modifier_number_format($_smarty_tpl->tpl_vars['cart']->value['total'],2),$_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'],$_smarty_tpl->tpl_vars['system']->value['system_currency_dir'] ));?>
            ...
            <div class="text-end">
              <button type="button" class="btn btn-success btn-lg js_shopping-checkout" <?php if (!$_smarty_tpl->tpl_vars['cart']->value['items'] || $_smarty_tpl->tpl_vars['user']->value->_data['user_wallet_balance'] < $_smarty_tpl->tpl_vars['cart']->value['total']) {?>disabled<?php }?>>
                <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Checkout" ));?>
...
/market/orders" method="get">
          <input type="text" class="form-control form-control-sm" name="query" placeholder='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Search" ));?>
'>
        </form>
      </div>
      <!-- search -->
      <div class="articles-widget-title lg">
        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Orders" ));?>
 <?php if (!$_smarty_tpl->tpl_vars['query']->value) {?><span class="badge bg-info rounded-pill"><?php echo $_smarty_tpl->tpl_vars['orders_count']->value;?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['query']->value) {?>
          <span class="badge bg-secondary rounded-pill"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "for" ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
      ...
      <!-- see-more -->
      <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['orders']->value) >= $_smarty_tpl->tpl_vars['system']->value['max_results']) {?>
    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="stat-panel bg-gradient-primary">
          <div class="stat-cell narrow">
            ...
            <span class="text-lg"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Total Orders" ));?>
</span><br>
          </div>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="stat-panel bg-gradient-info">
          <div class="stat-cell narrow">
            ...
            <span class="text-xxlg"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'print_money' ][ 0 ], array( smarty_modifier_number_format($_smarty_tpl->tpl_vars['monthly_sales']->value,2) ));?>
</span><br>
      ...
      <div class="col-lg-4">
        <div class="stat-panel bg-gradient-info">
          <div class="stat-cell narrow">
            <i class="fa fa-dollar-sign bg-icon"></i>
            <span class="text-xxlg"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'print_money' ][ 0 ], array( smarty_modifier_number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_market_balance'],2) ));?>
</span><br>
...
'>
      ...
      <!-- search -->
      <div class="articles-widget-title lg">
        <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ '__' ][ 0 ], array( "Sales Orders" ));?>
