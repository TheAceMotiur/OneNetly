...
if (!$user->isAdmin()) {
    redirect('dashboard.php', 'Only administrators can delete blog posts', 'error');
}
...
if (isset($_GET['confirm']) && $_GET['confirm'] === 'yes') {
    ...
    if ($result['success']) {
        redirect('dashboard.php', 'Blog post deleted successfully', 'success');
    } else {
        redirect('dashboard.php', 'Failed to delete blog post: ' . $result['message'], 'error');
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Delete Blog Post - OneNetly</title>
        ...
        <div class="flex-1">
            ...
            <header class="bg-white shadow">
                <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                    <h1 class="text-2xl font-semibold text-gray-900">Delete Blog Post</h1>
                </div>
            </header>
            ...
            <main class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="text-center">
                        <h2 class="text-xl font-semibold text-gray-900 mb-4">Are you sure you want to delete this blog post?</h2>
                        <p class="text-gray-600 mb-6">
                            <strong>Title:</strong> <?php echo htmlspecialchars($blogPost['title']); ?><br>
                            <strong>Status:</strong> <?php echo ucfirst($blogPost['status']); ?><br>
                            <strong>Created:</strong> <?php echo date('F j, Y', strtotime($blogPost['created_at'])); ?>
                        </p>
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-6 inline-block">
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <a href="delete-post.php?id=<?php echo $postId; ?>&confirm=yes" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                                Delete Permanently
                            </a>
                        </div>
                    </div>
