...
<div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
    ...
    <div class="p-6">
        <div class="prose max-w-none">
            ...
            <p>We are not responsible for any content, features, products, services, or practices of third-party websites. Visiting these external sites is at your own risk. We recommend that you review the terms and policies of every website you visit.</p>
            ...
            <p>OneNetly does not endorse any content contributed by users. We expressly disclaim any responsibility for user-submitted content or any loss or damage arising from it.</p>
            
            <h2>Downloads and Files</h2>
            ...
            <p>We strongly recommend users to verify the source of any downloads, scan files for viruses, and ensure they have proper legal rights to use any downloaded materials.</p>
