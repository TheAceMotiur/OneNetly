...
<body class="bg-gray-100 text-gray-800 p-4 md:p-6 flex flex-col min-h-screen">
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      form.addEventListener('submit', async (e) => {
        ...
        try {
          ...
          downloadBtn.className = 'bg-gray-200 px-4 py-2 mt-4 rounded flex items-center gap-2 hover:bg-gray-300 transition';
  ...
  <footer class="mt-auto pt-6 text-center text-sm text-gray-500">
    <p>OneNetly AI Image Generation | Powered by Stable Diffusion XL</p>
    <p class="mt-1">© ${new Date().getFullYear()} OneNetly</p>
  </footer>
</body>
</html>`;
}
