...
<div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
    ...
    <div class="p-6">
        <div class="prose max-w-none">
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">2. Definitions</h2>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">3. User Accounts</h2>
            ...
            <p class="mt-3">You are responsible for safeguarding the password that you use to access our Website and for any activities or actions under your password.</p>
            <p class="mt-3">You agree not to disclose your password to any third party. You must notify us immediately upon becoming aware of any breach of security or unauthorized use of your account.</p>
            
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">4. User Conduct</h2>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">5. Intellectual Property</h2>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">6. User-Generated Content</h2>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">7. Third-Party Links</h2>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">8. Termination</h2>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">9. Limitation of Liability</h2>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">10. Governing Law</h2>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">11. Changes to Terms</h2>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-4">12. Contact Us</h2>
